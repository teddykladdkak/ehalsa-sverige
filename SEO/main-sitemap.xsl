			...
			<body>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<div id="description">
							<h1>KML File</h1>
							<p>This file is used to provide location information to Google.</p>
							<p>Learn more about <a href="https://developers.google.com/kml/documentation/" target="_blank">KML File</a>.</p>
						</div>
						<div id="content">
							<p class="expl">This KML file contains <xsl:value-of select="count(kml:kml/kml:Document/kml:Folder/kml:Placemark)"/> Locations.</p>
					...
					<xsl:otherwise>
						<div id="description">
							<h1>XML Sitemap</h1>
							<p>This is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on this website.</p>
